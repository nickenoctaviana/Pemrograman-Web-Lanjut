...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="nav-item dropdown" >
                    ...
                    <a class="dropdown-item" href="/setting">Pengaturan Akun</a>
        ...
        <!-- akhir navbar -->
        <!-- dropdown -->
        <div class="dropdown" style="margin-top:80px;margin-left:230px;">
            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
               Kategori
            </button>
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="/berhasil">Berhasil</a>
                <a class="dropdown-item" href="/dibatalkan">Dibatalkan</a>
            </div>
            </div>
        <div class="container">
        <div class="riwayat">
